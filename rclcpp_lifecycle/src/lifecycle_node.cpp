...
: node_base_(new rclcpp::node_interfaces::NodeBase(
  ...
  node_clock_(new rclcpp::node_interfaces::NodeClock(
      node_base_, node_topics_, node_graph_, node_services_, node_logging_, options.clock_type())),
  ...
  node_time_source_(new rclcpp::node_interfaces::NodeTimeSource(
      ...
      node_parameters_, options.clock_qos(), options.use_clock_thread())),
...
const char * LifecycleNode::get_fully_qualified_name() const
{
...
bool LifecycleNode::register_on_configure(
  std::function<LifecycleNodeInterface::CallbackReturn(const State &)> fcn, bool is_async)
{
...
node_interfaces::LifecycleNodeInterface::CallbackReturn LifecycleNode::on_deactivate(const State &)
{
  impl_->on_deactivate();
  return LifecycleNodeInterface::CallbackReturn::SUCCESS;
}
